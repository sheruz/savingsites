...
public function get_profile_update($id,$fn,$ln,$phone, $carrier,$alternatephone = []){
	$common = new CommonController();
	$sr = 0;
	$data = array('first_name' => $fn, 'last_name'=>$ln , 'phone'=>$phone, 'carrier'=>$carrier);
	$common->updateData('users',$data,['id' =>$id]);
