...
# + get_all_organizations -> To get all the Organizations in a zone for Bulk Email //Added on 6/8/14
	public function get_all_organizations($zoneid){ 
   	...
   	public function getuserdealsbyid($zone_id, $user_id , $dealid, $purchaseID){
   		$result = '';
	...
	public function getuserdeals($zone_id, $user_id){
		$finalArr = [];
		$fetch_id="SELECT * FROM tbl_deals_purchased_meta WHERE userId=".$user_id."";
...
# - get_announcements_in_zone_for_approve
	...
	public function get_announcements_by_zone($zoneId='',$lowerlimit=0,$upperlimit=10)
	{ 				
