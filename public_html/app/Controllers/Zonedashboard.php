...
class Zonedashboard extends BaseController{
    ...
    public function sendEmailSnapONUSer(){
        ...
        foreach ($result as   $value) {
			if($value['zone_id'] && $value['user_id']){	  
                 // /$this->sendCustomemail($value['zone_id'] , $value['user_id']);

                $this->sendCustomemail(213 , $value['user_id']);
	    	}
	    }
	}
    ...
    public function sendCustomemailold($zoneid , $userID){
    	$postLimit = ''; 	
 		$Today=date('d/m/y');
		$promoexpiredate=Date('d/m/y', strtotime('+3 days'));
		$generatedPromoCode = $this->generatePRomo();
		
		// $query_certificate =  array("code"=>'"'.$generatedPromoCode.'"', "zoneid"=>$zoneid, "userid"=>$userID); 
	 //    $insertedID = $this->CommonController->InsertData('tbl_promo_code',$query_certificate);
 ...
 foreach ($addlist as  $value) {
		...
		foreach ($auction_result_setting as $key =>  $auction_result_setting) {
			...
			<table border="0" cellpadding="0" cellspacing="0" class="heading_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
				...
				<div style="color:#000000;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
				<p style="margin: 0;"> '.$auction_result_setting['tech_description'].'</p>
				</div>
				</td>
				</tr>
				</tbody></table>
				...
				<td style="padding-bottom:10px;padding-top:10px;">
				<div style="color:#000000;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
				<p style="margin: 0;">'.$auction_result_setting['cat_name'].'</p>
				</div>
				</td>
				</tr>
				</tbody></table>
 ...
 $htmlAds .= '</tbody></table>';
			...
			<div class="our-class" style="    background: #283434a1;
			    color: #fff;
			    font-size: 16px;
			    font-style: normal;
			    font-weight: 600;
			...
			<a target="_blank" href="'.base_url().'/businessSearch/search/'.$zoneid.'?promo='.base64_encode($generatedPromoCode).'&exxpiresat='.$promoexpiredate.'" style="font-size: 25px;
			    line-height: 50px;color: #fff;">Your Promo Code:
			'.$generatedPromoCode.'<br></a>
			<span style="font-style: normal !important;font-size:13px;text-decoration: underline;position: relative;
			    top: 4px;">Expires  '.$promoexpiredate.'.  Restrictions Apply.
			...
			<div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#bd1f36;border-radius:4px;width:auto;border-top:1px solid #bd1f36;border-right:1px solid #bd1f36;border-bottom:1px solid #bd1f36;border-left:1px solid #bd1f36;padding-top:5px;padding-bottom:5px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;    width: 100%;
			    position: relative;
			    top: -60px;"><a href="'.base_url().'/zone/'.$zoneid.'" style="padding-left:20px;color: #fff;padding-right:20px;text-decoration: none;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">&nbsp;<strong>Free $1.50 Credits</strong></span>&nbsp;</a></div>
		...
		$recipient = 'raman.zabius@gmail.com';
		...
		try {
		    ...
		    // $mail_aws->addCustomHeader('X-SES-CONFIGURATION-SET', $configurationSet);
  ...
  public function sendCustomemail($zoneid , $userID, $subcatids = '',$url = ''){
  	$postLimit = ''; 	
 		$Today=date('d/m/y');
		$promoexpiredate=Date('d/m/y', strtotime('+3 days'));
		$generatedPromoCode = $this->generatePRomo();
			...
			foreach ($addlist as  $value) {
				...
				if($peekaboo_id && $peekaboo_type){
					...
					foreach ($auction_result_setting as $key =>  $auction_result_setting) {
						...
						if($auction_result_setting['card_img']){
							$htmlAds .='<table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
								<tbody><tr><td style="width:100%;padding-right:0px;padding-left:0px;padding-top:15px;"><div align="left" style="line-height:10px"><img src="'.base_url().'/uploads/zone_mobile_resizeupload/'.$zoneid.'/'.$auction_result_setting['card_img'].'" style="display: block; height: auto; border: 0; width: 235px; max-width: 100%;" width="235"></div></td></tr></tbody></table>';							
						}else{
				 			$htmlAds .='<table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
								<tbody><tr><td style="width:100%;padding-right:0px;padding-left:0px;padding-top:15px;">
								<div align="left" style="line-height:10px"><img src="'.base_url().'/assets/businessSearch/images/support_orgs.jpg" style="display: block; height: auto; border: 0; width: 235px; max-width: 100%;" width="235"></div></td></tr></tbody></table>';	
						}
						
						$htmlAds .='<table border="0" cellpadding="0" cellspacing="0" class="heading_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%"><tbody><tr><td style="padding-bottom:10px;padding-top:10px;text-align:center;width:100%;"><h1 style="margin: 0; color: #1f1f1f; direction: ltr; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; font-size: 13px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><strong>'.$auction_result_setting['page_title'].'</strong></h1></td></tr></tbody></table>
							<table border="0" cellpadding="0" cellspacing="0" class="html_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%"><tbody><tr><td>
								<div align="center" style="font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;"><div class="our-class" style="text-align: left; font-weight: bold;"><s>$'.$auction_result_setting['current_price'].'</s> <span style="color:#bd2036">$'.$auction_result_setting['publisher_fee'].'</span> <span style="background: #000; color: #fff; font-size: 13px; padding: 5px;">$'.$savings.' OFF</span> </div></div></td></tr>
								</tbody></table>
							
							<table border="0" cellpadding="0" cellspacing="0" class="paragraph_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%"><tbody><tr><td style="padding-bottom:10px;padding-top:10px;">
								<div style="color:#000000;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;"><p style="margin: 0;"> '.$auction_result_setting['tech_description'].'</p></div></td></tr></tbody></table>

							<table border="0" cellpadding="0" cellspacing="0" class="paragraph_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%"><tbody><tr><td style="padding-bottom:10px;padding-top:10px;">
								<div style="color:#000000;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;"><p style="margin: 0;">'.$auction_result_setting['cat_name'].'</p></div></td></tr></tbody></table>
							<table border="0" cellpadding="0" cellspacing="0" class="button_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
								<tbody><tr><td style="padding-bottom:25px;padding-top:10px;text-align:left;">
								<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:42px;width:114px;v-text-anchor:middle;" arcsize="3%" stroke="false" fillcolor="#bd2036"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:16px"><![endif]-->
								<div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#bd2036;border-radius:1px;width:auto;border-top:1px solid #bd2036;border-right:1px solid #bd2036;border-bottom:1px solid #bd2036;border-left:1px solid #bd2036;padding-top:5px;padding-bottom:5px;font-family:Roboto, Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">';
							if($subcatids != ''){
								$htmlAds .='<a href="'.$url.'?subcatid='.$subcatids.'" style="text-decoration: none;color: #fff;padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">View Deal&nbsp;</span></a>';
							}	else{
								$htmlAds .='<a href="'.base_url().'/businessSearch/search/'.$zoneid.'" style="text-decoration: none;color: #fff;padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">View Deal&nbsp;</span></a>';
							}
							
							$htmlAds .='</div></td></tr></tbody></table> ';
							$htmlAds .= '</td></tr>';
              $adslistCount++;
            }
          }  
        ...
        $htmlAds .= '</tbody></table>';
 				...
 				$html = '<!DOCTYPE html><html lang="en" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
					...
					* {
					...
					<body style="background-color: transparent; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;"><table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: transparent;" width="100%"><tbody><tr><td>
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;" width="100%"><tbody><tr><td>
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; width: 810px;" width="810"><tbody><tr>
							<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
							<table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
							<tr>
								<td style="padding-top:20px;width:100%;padding-right:0px;padding-left:0px;">
					...
					<table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
					<tr><td style="padding-top:20px;width:100%;padding-right:0px;padding-left:0px;">
						<div align="center" style="line-height:10px"><a href="'.base_url().'/zone/'.$zoneid.'" style="outline:none" tabindex="-1" target="_blank"><img alt="logo" class="big" src="'.base_url().'/assets/template-images/image002.png" style="display: block; height: auto; border: 0; width: 810px; max-width: 100%;" title="logo" width="810"/></a></div></td>
					</tr>
				</table>
			</td>
			</tr>
	...
	public function zonedetail($zoneid=0,$fromzoneid=0,$sess_destroy=0){
		$this->CronController->rankbusiness($zoneid);
	   $businessArr = $pbcashcert = $categories = $keyaws = $EmailformatingSaved = $subcatnew = $all_sponsored_business_details = $selected_display_categories = $display_categories =  $display_categories = $adsarr = $get_paypal_info = $purchasedealArr = $userpassArr = $savedorganization = $businessrankbid = $totalsumfavorg = $monthArr = [];
	   $login_type = $login_id = $refer_code = $user_id = '';
	   $nonfavper = 10;
      ...
      if (empty($uid)) {
        return redirect()->to(base_url().'/zone/'.$zoneid.'/');
        	...
        	return redirect()->to(base_url().'/organizationdashboard/organizationdetail/'.$login_id.'/'.$zoneid.'/');
				...
				if($login_id != $zoneid){
					return redirect()->to(base_url().'/Zonedashboard/zonedetail/'.$login_id.'/');
				}
	   	}
  	 $pagesidebar = isset($_GET['page'])?$_GET['page']:'zoneinformation';
	   ...
	   if($pagesidebar == 'myzonebusiness'){
   	   	$businessArr = $this->getMyZoneBusiness($zoneid,$lowerlimit,$upperlimit);	
   	   }
   	   	if($pagesidebar == 'create_deal' || $pagesidebar == 'makenewadvertisement'|| $pagesidebar == 'viewads'){
   	   		...
   	   		$businessArr = $this->create_deal($zoneid);	
   	   		foreach ($businessArr as $key => $value) {
   	   	  	$lowerlimit=0; $upperlimit=1000; 
		   			$adsarr[$value['name']] = $this->Ads_model->get_ads_for_business_new($value['businessid'],$uid,$lowerlimit,$upperlimit,1); 
   	   		}
   	   	}
   	   if($pagesidebar == 'viewdeals'){
   	   	$businessArr = $this->alldeals($zoneid);	
   	   }
        ...
        if($pagesidebar == 'paypal_as'){
       		...
       		$pbcashqry="SELECT a.*,b.start_date,b.end_date,b.created_date,b.deal_title,b.deal_description,b.status,c.card_img,d.email,d.first_name,d.last_name,d.phone,e.purchasedAt,c.company_name,c.publisher_fee FROM tbl_deals_purchased_meta as a INNER JOIN tbl_deals as b ON a.dealID=b.deal_id INNER JOIN tbl_deals_products as c ON b.product_id=c.deal_product_id INNER JOIN users as d ON d.id=a.userId INNER JOIN tbl_deals_purchased as e ON e.userId=a.userId GROUP BY b.deal_id";
   	   	...
   	   	$savedorganization = $this->CommonController->SelectJoinMulti('organization as a', $joinArr1,$whereorg,[],[],'a.id as orgid,a.name as orgname,c.id as userid,c.username,c.email,c.first_name,c.last_name,a.zoneid as zoneuserid,c.status,c.uploaded_organization_password','','','',[],'','');


   	   	/*fetch organization using zipcodes*/
   	   	$orgzipqry="SELECT a.*, b.zip as orgzip  FROM organization as a INNER JOIN users as b ON a.userid=b.id WHERE b.zip!=''";
				$orgzipArr = $this->CommonController->SelectRawquery($orgzipqry,'resultArray');

				$tblzipqry = "SELECT b.zip as saleszonezip  FROM sales_zone as a INNER JOIN tblClaimedZips as b ON a.sales_rep_id=b.uid WHERE a.id=".$zoneid."";
				$tblzipArr = $this->CommonController->SelectRawquery($tblzipqry,'resultArray');
				if(count($tblzipArr) > 0){
					foreach ($tblzipArr as $ks1 => $vs1) {
						$zipArrlist[] = $vs1['saleszonezip'];
					}
				}
				// echo "<pre>";print_r($zipArrlist);die;
				// if(count($orgzipArr) > 0){
				// 	foreach ($orgzipArr as $ks => $vs) {
				// 		$this->CommonController->updateData('organization',['zip' => $vs['orgzip']],['userid' => $vs['userid']]);
				// 	}
				// }
   	   	/*fetch organization using zipcodes*/
	...
	public function getMyZoneBusiness($zoneid = 0,$lowerlimit = 1,$upperlimit = 10){
	   ...
	   $joinArr[] = ['table' => 'address as c','link' => 'c.id=a.addressid','type' => 'left'];
   	   ...
   	   $select = 'a.id,a.name,a.contactfirstname,a.contactlastname,f.phone,c.zip_code';
...
public function update_profile(){ 		
	...
	public function update_password(){	 
		...
		// $identity = $this->session->get($this->config->item('identity', 'ion_auth'));
	...
	public function listofcategory(){
		$sql_get_categories = "SELECT id , name FROM `category_new` WHERE STATUS = 1 AND id != -99 order by name ASC";
...
################################################  Zone Business Part Start #################################################################
	...
	*/
	...
	public function alldeals($zoneid=false,$fromzoneid=0){   
  	$count= 0;
  	$auction_data = [];
...
################################################  New Organization Start ####################################################################################	
	...
	*/
	...
	public function organization_registration($id= -1,$organizationname='',$accounttype = '',$email = '',$username = '',$zipcode= '',$state = '',$city='',$firstname='',$lastname='',$phone='',$address='',$password='',$salt='',$pass='',$selzone = '',$viacsv = 0){
		...
		$zone_id = isset($res_zone_owner_email[0]['id'])?$res_zone_owner_email[0]['id']:$selZone;
		...
		$data_org=array('name' => $org_name,'type'=>$org_type,'zoneid' => $zone_id,'userid'=>$organization_owner_id,'announcement_display'=>0,'approval'=>1,'viacsv'=>$viacsv,'zip'=>$zip); 
		...
		// + Mail to the user and to the zone owner 
		if($id>0){
			$message_sub ="Hey ".$fname.' '.$lname." Your ". $org_name." Registration Successful.";
			$message_body="<div style='border:1px solid #900; padding:5px;'><font size='4'>Dear ".$org_name.",<br /><br />Thank you for your SavingsSites registration.<br/><br/>You can login into your account and change the information at your convenience.<br /><br />We are constantly trying to improve this application, and will notify you of future updates <b>when</b> they are available. If you have any <b>questions</b> in the meantime, then please email us at <a href='mailto:support@savingssites.com'>support@savingssites.com</a> and we will get back to you promptly.<br/><br/>Best Regards,<br/>Savings Sites Support<br/><br/><hr>Please add <a href='mailto:noreply@savingssites.com'>noreply@savingssites.com</a> to your email whitelist.<br/><br/></font>";
			// $send = $this->CommonController->SendMail('',$org_email,$message_sub,$message_body);
		}
		if($selZone != -1){ 	
			if(count($res_zone_owner_email) > 0){
				$ZO_email = $res_zone_owner_email[0]['email'];
				$ZO_fname = $res_zone_owner_email[0]['first_name'];
				$ZO_lname = $res_zone_owner_email[0]['last_name'];
				$zone_id = $res_zone_owner_email[0]['id'];
				...
				$message_body="<div style='border:1px solid #900; padding:5px;'><font size='4'>Hi, ".$ZO_fname."<br /><br />
				...
				// $send = $this->CommonController->SendMail('',$ZO_email,$message_sub,$message_body);
			}
    }else if($zip!=-1){	
    	if(count($res_sql_zone_from_zip) > 0){
    		$zip_Zo_mail = $res_sql_zone_from_zip[0]['email'];
				...
				$message_sub = "Thank You For Registering!";
				$message_body="<div style='border:1px solid #900; padding:5px;'<font size='4'>Hi, ".$zip_Zo_fname."<br /><br />A new organization owner has registered in ".$zip_Zo_name.". The following are the user details.<br/><br/>	
					Organization Name : ".$org_name."<br /><br />
					First Name:  ".$fname."<br /><br />
					Last Name:  ".$lname."<br /><br />
					Telephone:  ".$phone."<br /><br />
...
#########################################################   Grocery Coupon Banner End    ##############################################################
  ...
  public function update_organization(){
	...
	public function checkexistsbid(){
		...
		$pbcashqry="SELECT * FROM  business_bid_detail WHERE business_id=".$business_id." AND month=".$newdate." ";
		$purchasedealArr = $this->CommonController->SelectRawquery($pbcashqry,'count');
