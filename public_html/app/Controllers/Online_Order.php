...
array_push($data['category_subcat_list'][$key]['subcategory'],$data['subcategory_list'][$key2]);
    ...
    {
    	var_dump($businessid);
        $data['businessDetails'] = array(); //$this->delivery->get_business_by_id($businessid);
        var_dump($zoneid);
        $data['zonedetails']    = $this->get_zone->get_zone($zoneid); 
        var_dump($businessid);
        $data['zoneid']=$zoneid;
        $data['businessid']=$businessid;
        $data['category_subcat_list'] = array(); //$this->fetchCategorySubcategory($zoneid,$businessid,6,"");
