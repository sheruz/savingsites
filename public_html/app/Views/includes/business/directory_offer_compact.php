				...
				if(empty($dealImage) && empty($ad['peekaboolist'])){
  				...
  				if (!empty($ad['peekaboolist']) && empty($dealImage)) {
					if(@$ad['bs_commonimage']){
						...
						if(!$handle2){
							$dealImage = base_url().'assets/businessSearch/images/support_orgs.jpg';
						}else{
		               			...
		               			<?php if (!empty($user_id)) {   ?>
									...
									<?php if ($ad['snap_status'] == 1) { ?>
									   	<a class="toggle-on-off-img on emailnoticepopup" style="cursor: pointer;" data-target="#email_notice_pop_up_modal" data-toggle="modal" data-adid="<?php echo $ad['adid'] ?>" data-busid="<?php echo $ad['bs_id'] ?>" data-userid="<?php echo $user_id ?>">
									   		<img data-on="images/snap-on.png" data-off="<?=$link_path ?>assets/businessSearch/images/turn-on.png" src="<?=$link_path ?>assets/businessSearch/images/snap-on.png" class="for-img-shadow"/>
									   	</a>
									<?php } else { ?>
									   	<a class="toggle-on-off-img on emailnoticepopup" style="cursor: pointer;" data-target="#email_notice_pop_up_modal" data-toggle="modal" data-adid="<?php echo $ad['adid'] ?>" data-busid="<?php echo $ad['bs_id'] ?>" data-userid="<?php echo $user_id ?>" >
									   		<img data-on="images/turn-on.png" data-off="<?=$link_path ?>assets/directory/images/snap-off.png" src="<?=$link_path ?>assets/businessSearch/images/snap-off.png" class="for-img-shadow"/>
									   	</a>
									<?php } ?>
									</span>
								<?php } else { ?>
									<span class="snapdiv">
										<a href="javascript:void(0);" aria-hidden="true"  data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Snap is Turned OFF. Login to turn it ON" data-original-title="SNAP">
											<img src="<?=$link_path ?>assets/businessSearch/images/snap-off.png" style="width: 25px;">
										</a>
									</span>
								<?php } ?>
...
if (!empty($user_id)) {
								...
								<?php } else {
								?>
								<div class="text-center"><img class="support_img s2" src="<?=$link_path ?>assets/businessSearch/images/support_orgs.jpg" /></div>
							...
							if (!empty($user_id)) {
                         	...
                         	<a target="_blank" href="<?php echo base_url() ?>zone/my_deal/<?= $zone ?>/<?php echo $ad['bs_id'] ?>/<?php echo $ad['adid'] ?>" ><img src="<?=$link_path ?>assets/businessSearch/images/multimedia.png" style="width:20px;"></a></div>
...
<div id="login_loadings" style="  display: none;  top: 136%;position: absolute;left: 0;right: 0;z-index: 99999; "> <img id="loading1" src="/assets/images/loading.gif" width="50" height="50" alt="loading" ></div>
