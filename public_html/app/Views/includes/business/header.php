...
<header class="desktop_view">
   <div class="container">
      <div class="row align-middle">
         <div class="col-md-3">
            <div class="main_logo">
               <img src="<?= base_url();?>/assets/SavingsUpload/images/new-savingssites3.png">
               ...
               <li role='navigation ' id="checkk" class="dropdown-submenu new com_li hide_on_desktop">
                  ...
                  <ul class="dropdown-menu_list1" id="menu-bar-mobile" >
                     ...
                     <li class="sign_out_directory"> 
                        <a href="<?=base_url() ?>/Zonedashboard/zonedetail/<?= $zoneid; ?>" class="btn-link cus-top-pad"><i class="fa fa-edit text-primary "></i> Back To Dashboard</a>
                     </li>
                     <li class="sign_out"> 
   ...
   <span class="mobile_hide">Filters</span>?</a>
         ...
         <div class="col-md-6">
           <div class="center_text_no_profit">
               <h2>You Save & Your Favorite <span>Non-Profit Also Benefits!</span>
<img src="<?= base_url(); ?>/assets/stylesheets/images/info-icon-27.png" class="showonlick">
               </h2>
            ...
            <div class="login_cart_icon">
               ...
               <li role='navigation ' id="checkk" class="dropdown-submenu new com_li">
                  ...
                  <ul class="dropdown-menu_list1" id="menu-bar" >
                     ...
                     <?php } ?>
                     <div class="video_modal mobile_view_new0">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#about-modal">About</button>
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#foodModal">Deals Video</button>
                        <a href="#aboutDining" data-toggle="modal" data-target="#snap_filter" class="with-icon btn-link btn btn-info btn-lg" style="margin-left: 5px;">SNAP<span class="mobile_hide">Filters</span>?</a>
                     </div>
                     <div class="logo">
                        <ul class="logo-row first-row">
                           <li>
