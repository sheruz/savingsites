<header class="section page-header home_header ade">
                ...
                <div class="row justify-content-center align-items-xl-center">
                    <div class="col-sm-12">
                        <div class="menu-center mobile_view">
                            ...
                            <a class="brand" href="<?= base_url(); ?>"><img src="<?= base_url(); ?>/assets/home/directory/images/logo-green.png" alt=""></a>
                        </div>
                                        </div>
                    <div class="col-12 col-lg-6 col-md-4 bv_welcome_col">
                        ...
                        <li><a href="<?= base_url(); ?>/home/contact_us" class="bv_contact_btn">Contact</a></li>
                            ...
                            <ul class="dropdown-menu_list1" id="menu-bar" style="display: none;">
                                ...
                                <div class="logoss">
                                    <ul class="logo-row first-row">
                                        <li>
                                            <a href="<?= base_url(); ?>/businessSearch/search/<?= $zoneid;?>" target="_blank"><img class="disable 8" style="" src="<?= base_url(); ?>/assets/home/directory/images/new-savingssites.png"></a>
                                        </li>
                                    </ul>
                                </div>
                            </ul>
                                                    ...
                                                    <div class="rd-navbar-main">
                                                        <div class="rd-navbar-panel">
                                                            <li class="user-register new_logo rd-nav-item">
                                                                <a class="busines_search gl" href="javascript:void(0);"><img class="logo-ssb" style="" src="<?= base_url(); ?>/assets/home/directory/images/logo-green.png"></a>
                                                            </li>
...
<div class="modal-body">
                        ...
                        <p>Mobile: <strong><a href="tel:+9736189906">9736189906</a></strong></p>

                        <p>Email: <strong><a href="mailto:al@savingssites.com">al@savingssites.com</a></strong></p>
