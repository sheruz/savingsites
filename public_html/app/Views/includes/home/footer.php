...
jQuery('.carp2').css('display','inline-block');
    ...
    $(document).ready(function() {
        ...
        $(".busines_search").click(function(e){ 
            e.preventDefault();
            $('.page-loader').show();  
            var businessSearchUrl = "<?php echo base_url() ?>/businessSearch/search/<?php echo $zoneid ?>";
    ...
    $(document).on('click','.normal_user_profile1',function() {
        window.location = base_url+"/zone/my_account/<?=$zoneid?>/";
    });
    ...
    $(document).on('click','.sign_out_directory',function(){
        if(user_id!='' && user_id!='undefined'){
            if(user_type == 4){
                ...
                var x = base_url + "/zone/my_account/"+ zoneId ;
            }else {
