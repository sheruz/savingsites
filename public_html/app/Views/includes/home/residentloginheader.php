                    ...
                    <div class="col-12 col-lg-3 col-md-8">
                        <div class="municipality-logo">
                            <a class="brand homelink" id="<?=$zoneid?>" href="javascript:void(0);">
                                <img src="<?= base_url();?>/assets/home/directory/images/logo-green.png" alt="" />
                            </a>
                        </div>
                    </div> 
                </div>
         ...
         <!--                <li class="sign_out_directorys ">
                ...
                <div class="col-12 col-lg-4 col-md-12">
                    <ul class="user-menu pull-left text-left textRightSide">
                        <li><a href="<?= base_url(); ?>/zone/contactus/<?=$zoneid?>" class="bv_contact_btn sdgsdds" style="font-size: 14px;">Contact</a></li>
