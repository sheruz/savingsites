      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td data-column="Last Name"><a target="_blank" href="<?=base_url();?>/zone/<?=$zone['seo_zone_name']?>" style="color:#000;"><?=base_url();?>/zone/<?=$zone['seo_zone_name']?></a>
            </td>
	        </tr>
        </tbody>
      </table>
    ...
    <div id="tab2" class="tab-content">
      ...
      <div class="row">
        <div class="col-md-6 bv_align_center">
          <img src="<?= base_url() ?>/assets/images/pexels-mati.jpg">
        </div>
          ...
          <div style="width: 100%;" id="showdiv">
            ...
            <div id="show_banner">
              <?php if(!empty($check_zone_logo[0]['image_name'])): ?>
                <img src="<?=base_url();?>/assets/SavingsUpload/zone_logo/<?=$check_zone_logo[0]['id']?>/<?=$check_zone_logo[0]['image_name'];?>" style="width: 100%;">
              <?php endif; ?>
            </div>
          </div>
            </div>
       ...
       <div class="top-title">
        ...
        <div class="form-group center-block-table">
          <form action="" method="post">
            ...
            <?php if($discountrate){ foreach (json_decode($discountrate) as   $value) { ?>
