...
<div class="page-wrapper main-area toggled makenewadvertisement">
   <div class="container">
    <div class="row" style=" margin-bottom: 80px;">
      <div class="top-title">
        <h2>Make New Advertisement</h2>
      ...
      <table class="display responsive-table datatable-all" cellspacing="0" width="100%" id="makenewad"> 
        <thead>
          <tr>
            <th scope="col" style="width:75%;">Business Name</th>
        ...
        <tbody>
         <?php foreach ($businessArr as $k => $v) {
            echo '<tr>';
            echo '<td style="width:75%;">'.$v['name'].'</td>';
            if($v['adsid'] > 0){
               echo '<td style="width:30%;"><span class="cus-solid-green" busname="'.$v['name'].'" busid="'.$v['businessid'].'" zoneid="'.$zone_id.'">Ads already Gen('.$v['adsid'].')</span></td>';
            }else{
               echo '<td style="width:30%;"><span class="addadvertisment cus-solid-blue" busname="'.$v['name'].'" busid="'.$v['businessid'].'" zoneid="'.$zone_id.'">+ Make New Advertisement</span></td>';
            }
            echo '</tr>';
         } ?>
        </tbody>
   ...
   <div class="row justify-content-center mt-0">
      <div class="col-sm-6 col-md-12 text-center">
         <div class="card">
            ...
            <input type="hidden" name="zonedashboardads"  id="zonedashboardads" value="1" />
                  ...
                  <form id="msform">
                     ...
                     <fieldset>
                        <div class="form-card">
                           ...
                           <div class="form-area">
                              <ul id="tabs-nav">
                                 <li><a href="#tab01">Text editor</a></li>
                                 <li><a href="#tab02">HTML editor</a></li>
                              </ul>
                              <div id="tab01" class="tab-content">
                                 <label>Deal Description</label>
                                 <textarea class="dealdescription form-control form-control-sm mb-3" id="dealdescription" rows="3"></textarea>
                                 <span id="text2000">2000 characters left</span>
                              </div>
                        ...
                        <div class="form-card">
                           ...
                           <div class="col-md-12">
                              ...
                              <table class="" id="categoryTable" width="700px" border="1" cellspacing="0" cellpadding="0" style="margin-top:10px; margin-bottom:0; overflow:scroll;">
                                 <tbody>
                                    <tr>
                                       <td style="font-weight: 700;color: #fff;"><input checked class="optioncategory" data-id="Restaurants" name="ad_category_fromshowad" id="ad_category_fromshowad" type="checkbox" value="1" style="margin: 0 10px;" >Restaurants</td>
                                    </tr>
                                 </tbody>
                              </table>
