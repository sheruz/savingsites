    ...
    <div class="tabs managephoto">
      <div id="tabs-content">
        <div id="tab1" class="tab-content bv_mange_photos" style="display: none;">
          ...
          <div class="row">
            <div class="col-md-6">
              <div style="width: 100%;padding: 60px;" id="showdiv" class="myclass">
                <!-- <span style=" color: #454cad; margin-bottom: 18px; float: left; font-weight: bolder;font-size: 15px;">First pick a category, and then upload the image.<br>Add category for your organization if category is not available. </span> -->
