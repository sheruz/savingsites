                  ...
                  <?php $cat_arr = explode(',',$ad['activatedcatid']);
                     foreach($cat_arr as $k => $val){
                        ...
                        if($subcat_group_name!=''){
                              echo '<span style="padding-left:15px;">'.$subcat_group_name.'</span><br>';
                        }
                        echo '<span style="padding-left:30px;">-'.$subcat_name.'</span><br>';
                     }
                  ?>
               </td>
               <td >
                        ...
                        <div class="form-card">
                           ...
                           <div class="col-md-12">
                              ...
                              <table class="" id="categoryTable" width="700px" border="1" cellspacing="0" cellpadding="0" style="margin-top:10px; margin-bottom:0; overflow:scroll;">
                                 <tbody>
                                    <tr>
                                       <td style="font-weight: 700;color: #fff;"><input class="optioncategory" data-id="Restaurants" name="ad_category_fromshowad" id="ad_category_fromshowad" type="checkbox" value="1" style="color:#096" >Restaurants</td>
                                    </tr>
                                 </tbody>
                              </table>
    ...
    <div class="row">
      ...
      <div class="panel">
         ...
         <div style="width: 100%;" id="showdiv">
            ...
            <div id="show_banner">
               <img id="adsimage" src="<?= base_url(); ?>/assets/uploads/zone_logo/<?php $zoneid; ?>/medium-shot-smiley-man-talking-phone_23-2149300624.jpg" style="width: 100%;">
            </div>
         </div>
      </div>
      <div class="col-md-6">
