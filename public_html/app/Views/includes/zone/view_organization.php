...
<div class="content_container bv_temp_business org">
...
<div class="container_tab_header" id="container_tab_header">View Organizations
<?php if($common['organizationid']!=''){ ?>
<div class="refferaldiv"><h4>Referral Code: <a  class="referalcopy" href="<?=base_url('businessSearch/search/'.$common['zoneid'].'/'.@$referralCode) ?>"><i class="fa fa-copy"></i> <?php echo @$referralCode ?></a></h4></div>
 <?php } ?>
    ...
    <div id="msg" style="display:none;"></div>
        ...
        <div class="container_tab_header form-group ve_org_head" >

       <!--Active/Deactive-->

        <button class="btn-sm active_org active" onclick="showallorganization(<?=$zoneid?>,'all','',this.id); resetsearch();" type="button" id="1###org">Active Organizations</button>

        <button class="btn-sm deactive_org" onclick="showallorganization(<?=$zoneid?>,'all','',this.id); resetsearch();" type="button" id="-1###org">Inactive Organizations</button> 
 ...
 <!-- Search Part Start -->
    ...
    <div class="container_tab_header form-group" id="search_org" style="display:none;">
        ...
        <div class="bus_search_pbntc_active">
            ...
            <button class="btn-sm"  id="text_org_search_btn" type="button" onclick="showallorganization(<?=$zoneid?>,$('#text_org_search').val(),'',$('.organization_type').val());">Search</button><strong>Search Your Organization</strong>
 ...
 <!-- Search Part End -->            
                ...
                <tr class="headerclass_organization">
                  ...
                  <td colspan="5"><div id="action_performed_div" class="apmybusiness fright">
                      ...
                      <select name="action_performed" id="action_performed" class="action_performed_mybusiness w_215 select_style_sm" style="float:left;">
                        ...
                        <option value="1">Change Organization Status</option>
                      ...
                      <select name="organization_delete_all_or_specific" id="organization_delete_all_or_specific" class="w_215 select_style_sm">
                        ...
                        <option value="1">Selected Organizations</option>
        ...
        <div id="more_organization" class="text-default" style="text-align: right; font-weight: 700; background: transparent;"><a id="more_organization_limit" href="javascript:void(0)" onclick="showallorganization(<?=$zoneid?>,'all',this,$('.organization_type').val());" style=" color:#000;" rel="0,0">Display More Organizations</a> </div>
        ...
        <div id="organization" class=" form-group">
          ...
          <div class="container_tab_header form-group" style="background-color: rgb(189 188 201);
    color: rgb(34, 34, 34);
    font-size: 13px;
    margin-top: 10px;
    margin-bottom: 15px;
    ...
    padding: 10px;">
          ...
          <p> The username will get generated automatically based on the first 8 characters of the organization name followed by 6 random numbers.</p>

          <p> Clicking on the 'Generate Password' will automatically generate a random alpha-numeric password. </p>

          <p> Organization Username and Zone Username should not be same. </p>
          ...
          <p class="form-group-row">
            ...
            <label for="organization_password" class="fleft w_200">Password</label>

            <input type="text" id="organization_password" name="organization_password"/>

            <button onclick="create_generate_password()">Generate Password</button><br />

            <label for="organization_password" class="fleft w_200">

            <span style="color:red">Case sensitive, combination of 10-18 letters, numbers and special characters (!, @, #, $, %, &) </span>
          ...
          <button onclick="SaveOrganization()" name="save_organization">Save Organization</button>

          <button onclick="back_to_org()" name="back_organization">Back To Organization</button>
...
$(document).ready(function () { 
	...
	$('#zone_view_organization').addClass('active');
...
function showallorganization(zoneid,charval,tag,type){	
	 ...
	 if(authenticate=='0'){
		...
		if(type_org == 1){
			...
			var message="Displaying  The Activated Organization List...<br/>This may take a few seconds...";
			...
			var message="Displaying  The Deactivated Organization List...<br/>This may take a few seconds...";

		}

															// form the button  seding the tab value and thus sending tag in the pagemethod

		PageMethod("<?=base_url('Zonedashboard/getOrganizationData')?>/"+default_zone+"/"+charval+"/"+type_org+"/"+lowerlimit+"/"+upperlimit, message, null, showAccounceInformationOrg, null);
...
function OrganizationActionSuccessful(result) { //alert(JSON.stringify(result)); return false;
	...
	$('#msg').html('<h4 style="color:#0C0">Organization status has been changed successfully.</h4>').show();
...
function check_org_username(){
	...
	var data = { "zoneid": default_zone , "org_username": org_username ,"realtor_username": realtor_username, "org_id": org_id};
...
$('#organization_email').focusout(function(){
          ...
          $('#organization_email').filter(function(){
            ...
            if( !emailReg.test(email)){
				...
				$("button[name='save_organization']").attr('disabled','disabled');

				$("button[name='back_organization']").attr('disabled','disabled');
				...
				//$('#email_notice').fadeToggle();
					...
					$("button[name='save_organization']").removeAttr('disabled');

					$("button[name='back_organization']").removeAttr('disabled');
