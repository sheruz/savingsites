...
function Editcoupon(id){
	...
	window.location.href = "<?=base_url('Zonedashboard/Editcoupon/') ?>" + "/" + zone_id +"/"+ id ;
...
function showallcoupon(){
	...
	if(authenticate=='0'){			 
		...
		PageMethod("<?=base_url('Zonedashboard/more_coupon')?>" + "/" + zone_id, "Processing...<br/>This may take a minute.", null, showAccounceInformation, null);
...
function showAccounceInformation(result){ 
	...
	if(result.Tag!=''){
		...
		if(adsno == 0){
			...
			$("#showannouncement").html('<div class="container_tab_header" style="background-color:#222; color:#CCC; font-size:13px; text-align:center; margin-top:10px; margin-bottom:0px;">No Coupon info Found.</div>');
...
function delete_coupon(id) { 
	 ...
	 ConfirmDialog("Really delete this information? ", "Delete Coupon", "<?=base_url('Zonedashboard/delete_coupon')?>", "Deleting Coupon<br/>This may take a minute",dataToUse, announceSaveSuccessful, null);
...
<input type="hidden" id="coupon_id" value="<?=$coupon_list['0']['coupon_link'] ?>" />
...
<div class="container_tab_header">View Coupon Information</div>
...
<!---------------------------------------------------------------------Help Tips------------------------------------------------------------->
    ...
    <div id="container_tab_content" class="container_tab_content">   
        ...
        <div class="bv_coupan_tbl">

        <?php 

	   if(!empty($coupon_list['0']['coupon_link'])) {
       ...
       <div id="more_announcements" style="float:right;"><a id="my_announcements_limit" class="text-default" href="javascript:void(0)" onclick="showallcoupon();" rel=""></a> </div>

       <?php }}else{?>

       		<p><div id="not_found" class="container_tab_header" style="background-color:#222; color:#CCC; font-size:13px; text-align:center; margin-top:10px; margin-bottom:0px;">No coupon info found.</div></p>
