...
<?php if(!empty($franchisee_business_in_zone)) { ?>
<table class="pretty" border="0" cellpadding="0" cellspacing="0">
  <thead id="showhead" class="headerclass">
    <tr>
      ...
      <th width="12%">Select/<br/>Deselect All<br/><input type="checkbox" name="select_all_business_franchisee" id="select_all_business_franchisee"  value="all" title="Select/Deselect All" alt="Select/Deselect All" data-businesstype="<?=$business_type?>" data-businesstypebycategory="<?=$business_type_by_category?>" data-businesszone="<?=$business_zone?>"></th> 
    </tr>
  </thead>
  <tbody>
    <tr class="headerclass_sub">
      <td colspan="5"><div id="action_performed_div" class="fright">
          ...
          <button class="btn-sm"  id="update_franchisee_business" type="button" data-businesstype="<?=$business_type?>" data-businesstypebycategory="<?=$business_type_by_category?>" data-businesszone="<?=$business_zone?>">Update</button>
        </div></td>
    </tr>
    
	<? foreach($franchisee_business_in_zone as $key1=>$business){
    ...
    <tr id="<?=$business['businessid']?>" class="uploadbusiness <?=$displaytableview_class?>" >
      ...
      <td width="20%"><?=$business['first_name']?>
        &nbsp;
        <?=$business['last_name']?></td>
      <td> 
      <?=$business['phone']?>
        ...
        <td  width="30%">
        <a href="<?=base_url()?>businessdashboard/businessdetail/<?=$business['id']?>/<?=$zoneid?>" class="link-underlined text-default"><b>&#x2192; Go To Business Dashboard</b></a><br />
