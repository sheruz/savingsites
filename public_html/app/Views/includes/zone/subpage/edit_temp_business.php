                ...
                <input type="hidden" name="biz_business_type" id="biz_business_type" value="<?=$business_type?>"/>
                    ...
                    <p class="form-group-row">
                      <label for="button_save">
                        <button id="edit_update_temp_business" class="m_left_200" type="button" data-businesstype="<?=$business_type?>" data-businesstypebycategory="<?=$business_type_by_category?>" data-businesszone="<?=$business_zone?>">Update Business</button>
                      </label>
                    </p>
