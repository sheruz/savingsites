    ...
    <?php 
	 ...
	 ?>
        <tr class="org_row" id="<?=$org['id']?>">
            ...
            <td width="30%">
                <a href="<?=base_url()?>organizationdashboard/organizationdetail/<?=$org['id']?>/<?=$org['zoneid'];?>" class="link-underlined text-default"><b>&#x2192; Go To Organization Dashboard</b>
                </a><br />
                
                <a class="link-underlined text-default" onclick="EditOrganization(<?=$org['id']?>);" href="javascript:void(0)" id="edit_org" rel="<?=$org['id']?>" data-zoneid="<?=$org['zoneid'];?>" <?php /*?>data-businesstype="<?=$business_type?>" data-charvalname="<?=$charval_name?>"<?php */?> title="Edit <?=stripslashes($org['name'])?> Business"><b>&#x2192; Edit Organization</b>
                </a><br />
