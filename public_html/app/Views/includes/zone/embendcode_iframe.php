...
<?php } ?>
  ...
  <div class="container_tab_header">IFrame Code</div>
            ...
            <p>
              ...
              <div id="new_category" class="bv_new_webnier">
                  ...
                  <div class="paid boxes">                    
                      ...
                      <select class="savingdrop">
                         <option value="saving">Deals</option>
                        <option value="order">Order online</option>
                        <option value="snap">Snap Dining</option>
                  ...
                  <br/> <br/> 
                      <textarea class="linkcode" readonly style="    width: 100%;    height: 100%;    min-height: 400px;    padding: 24px 6px;"><iframe   src="<?=base_url() ?>businessSearch/search/<?php echo $common['zoneid'] ?>?embed=1" width='100%' height='100%'></iframe>
                      </textarea>
...
$(document).ready(function () {  
  ...
  $(".savingdrop").change(function() {
      
        if($(this).val() == 'saving'){
              $('.linkcode').text("<iframe   src='<?=base_url() ?>businessSearch/search/<?php echo $common["zoneid"] ?>?embed=1' width='100%' height='100%'></iframe>");
        }else if($(this).val() == 'snap'){

          $('.linkcode').text("<iframe   src='<?=base_url() ?>snapDining/dining/<?php echo $common['zoneid'] ?>?embed=1' width='100%' height='100%'></iframe>");
        }else{
         $('.linkcode').text("<iframe   src='<?=base_url() ?>online-delivery/<?php echo $common['zoneid'] ?>?embed=1' width='100%' height='100%'></iframe>" );
        }
    });
  ...
  $('#zone_data_other_accordian').addClass('active');
    ...
    $("#iframe_website").addClass('active');
