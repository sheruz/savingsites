...
<?php } ?>
  ...
  <div class="container_tab_header" style="position:relative;">
    	...
    	Filtered Query Results<input type="hidden" id="exportpattern" value="" />
...
$(document).ready(function () { //alert(1); 
	...
	$('#trial_business_expiration').addClass('active');
...
$(document).on('click','.more_non_temp_business',function(){ //alert(5);
	...
	PageMethod("<?=base_url('Zonedashboard/all_freetrial_business_expiration_filtering')?>", "Displaying Businessess...<br/>This may take a few minutes", data, successdata, null);
