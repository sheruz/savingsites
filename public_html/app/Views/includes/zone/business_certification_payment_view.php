...
<iframe src="<?php echo base_url()?>Zonedashboard/jot_form_view/<?php echo $business_id; ?>/<?php echo $zone_id; ?>/<?php echo $amount; ?>/4" width="70%" height="100%" frameborder="0"></iframe> 
</div>
