                ...
                <form id="create_business_form" class="form-validate vc_business_form" name="create_business" method="post" action="" onsubmit="save_banner()">
                    ...
                    <p class="form-group-row">
                        ...
                        <label for="email" class="fleft w_200 bv_top_logo">Top Position Logo</label>
                            ...
                            <span style="display:none;right: 240px;" id="spinner_lefttop"><img src="<?php echo base_url() ?>assets/images/loading.gif"></span>
                    ...
                    <p class="form-group-row">
                        ...
                        <label for="email" class="fleft w_200 bv_top_logo">Top Position Logo</label>
                            ...
                            <span style="display:none;right: 240px;" id="spinner_leftbottom"><img src="<?php echo base_url() ?>assets/images/loading.gif"></span>
...
$(document).on('blur','#biz_username',function(){ //alert(1);

    /*var chk_uname=/^[A-Za-z0-9]+$/; 

         //alert(userame); return false;

        if(!userame.match(chk_uname)){

            alert('username only supports alphanewmeric');
    ...
    if(regex.test(username) !== true){ //alert(userame);
        ...
        var data = { "user_name": userame};     //alert(zonename); //return false;
