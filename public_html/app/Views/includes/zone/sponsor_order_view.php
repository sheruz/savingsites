    ...
    <div id="container_tab_content" class="container_tab_content">
      ...
      <div id="tabs-1">
        ...
        <div class="form-group">
            ...
            <div class="container_tab_header" id="trial_biz" style="  color:#222; font-size:13px;margin-top:10px; margin-bottom:0px; display: none;">
...
$(document).ready(function () { //alert(1); 
  ...
  console.log("fgdfgd");
	...
	$('#order_sponsor_business').addClass('active');
...
$(document).on('click','.more_non_temp_business',function(){ //alert(5);
	...
	PageMethod("<?=base_url('Zonedashboard/get_ordered_sponsored_business_data')?>", "Displaying Businessess...<br/>This may take a few minutes", data, successdata, null);
