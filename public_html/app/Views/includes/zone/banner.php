...
<?php } ?>
	...
	<div id="container_tab_content" class="container_tab_content">
        ...
        <!--<li><a href="#tabs-6" onclick="resetnotification(6)">Home</a></li>-->
        ...
        <div id="tabs-1" class="bannercontainer" data-id="1">

        	<div class="form-group">

            <div class="container_tab_header header-default-message bv_head_wraper" style="/*background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px; overflow:hidden;*/">
...
function resetnotification(viewable_id){
  ...
  $.ajax({
      ...
      url:"<?=base_url('Zonedashboard/tabeviewZonebanner/'.$zone_id.'')?>",
...
var get_viewable_id = $(this).attr('data-id');

//$("#edit_banner").attr('name','edit_banner'+);

//alert(get_viewable_id);

$('#viewable_tabid_'+banner_id).val(get_viewable_id);
