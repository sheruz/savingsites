...
<div class="container" id="jotfrom_upload_form">
...
<?php } ?>   
<h1 class="container_tab_header">Embed Jot Form</h1>
    ...
    <form class="form-horizontal">
        <div class="form-group center-block-table">
            ...
            <select class="form-control" id="sel1">
             <?php foreach ($jotform_category_data['category'] as $category) { ?>
         ...
         <?php
          ...
          foreach ($jotform_category_data['category'] as $category) {
            $codes="";
            $category_type_id=$category['id'];
            if($jotform_category_data['form_codes']){
                $codes = $jotform_category_data['form_codes'][$category_type_id]['code'] ? $jotform_category_data['form_codes'][$category_type_id]['code'] : "";
            }
        ...
        <div class="form-group center-block-table text_area_to_save_code" data-category="<?= $category['id']; ?>" >
            ...
            <textarea  rows="18" cols="70" class="form-control" id="embed_code" name="codes_details" class="embed_codes" value="<?= $codes; ?>"><?= $codes; ?></textarea>
        </p>
        </div>
        <?php } ?>
