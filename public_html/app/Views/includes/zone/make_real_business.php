...
<div class="main_content_outer">
  <div class="content_container">
    <div class="container_tab_header"><strong>Businesses Yet To Make Real Offers </strong></div>
      ...
      <div id="tabs-1">
        <div class="form-group">
          <div class="container_tab_header" style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px; display:none;">
                ...
                <button class="btn-sm active_tbntc active" type="button" id="3###tbntc" >Search for Active Businesses</button>
                <button class="btn-sm deactive_tbntc" type="button" id="-3###tbntc">Search for Inactive Businesses</button>
            ...
            <div id="helpdiv1" class="container_tab_header header-default-message" >
        <p>This will show those Businesses whose category is other than Business Coming Soon and are waiting for approval. To approve them and allow them to go live in the Zone Directory page you need to change the status. To change the status select the from the drop down list the appropriate(Active Trial/Paid) status , select the needed businesses and then click on the "Update" button.</p>
        <p>Search your business directly by entering the name inside "Direct search by business name" text box and click on the "Search" option. Or search businesses alphabetically by selecting the desired alphabet and then click on the "Search" option.</p>
          ...
          <!-- Search Part Start -->
            <div class="container_tab_header" id="trial_biz" style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px; ">
...
$(document).ready(function () { //alert(1); 
	...
	$('#zone_change_status_business').addClass('active');
...
$(document).on('click','.deactive_tbntc',function(){ //alert('deactive_tbntc'); 
	...
	PageMethod("<?=base_url('Zonedashboard/view_make_real_offers_business_by_type')?>", "Displaying Businessess...<br/>This may take a few minutes", data, successdata, null);
});
...
$('#update_non_temp_business').live('click',function(){
	...
	if(action_performed==3 && action_performed_in_where==0 && business_delete_all_or_specific==1){
		...
		PageMethod("<?=base_url('Zonedashboard/action_performed_make_real_offers_business')?>", "Action Performed...<br/>This may take a few minutes", data, businesssuccess, null);
	}		
});
...
$(document).on('click','#back_to_business',function(){ 	
	...
	if(businesstype==1 && businesstypebycategory=='pbntc'){
		...
		$('.deactive_pbntc').click();
	}else if(businesstype==3 && businesstypebycategory=='tbntc'){
		$('.active_tbntc').click();
	}else if(businesstype==-3 && businesstypebycategory=='tbntc'){
		$('.deactive_tbntc').click();
