...
.content_container .ui-widget-content{
  padding-bottom: 47px;
}
...
$(document).ready(function () { //alert(1); 
  ...
  $('#order_snapdining_business').addClass('active');
...
$(document).on('click','.more_non_temp_business',function(){ //alert(5);
  ...
  PageMethod("<?=base_url('Zonedashboard/getsnap_dining_list')?>", "Displaying Businessess...<br/>This may take a few minutes", data, successdata, null);
});
