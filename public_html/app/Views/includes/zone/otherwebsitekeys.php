...
<?php } ?>
	...
	<div class="container_tab_header">Add Other Website's ID </div>
            ...
            <p>
            	...
            	<div id="new_category" class="bv_new_webnier">
                  ...
                  <div class="paid boxes">                    
                    ...
                    <label for="biz_sic" class="fleft w_150">Enter Huge Group Deal Website Referal  ID</label>

                   <input type="text" id="hugegroup_referralid" name="hugegroup_referralid"  class="w_300"  value="<?php if(@$resultdata['hugegroup_id']){ echo @$resultdata['hugegroup_id'];  } ?>"  />
                  ...
                  <br/>
                   ...
                   <label for="webinar_link" class="fleft w_150">Enter USA Group Rates Website Referal Id</label>

                    <input type="text"  id="usagroup_referralid" name="usagroup_referralid" placeholder="" value="<?php if(@$resultdata['usergroup_id']){ echo @$resultdata['usergroup_id'];  } ?>" class="w_300"/><br /><br />

                  </div>
                        
                    <label for="webinar_link" class="fleft w_150">Enter 365 Emailing Website Referal Id</label>

                    <input type="text" id="emailing_referralid"  name="emailing_referralid" placeholder="" value="<?php if(@$resultdata['emailing_id']){ echo @$resultdata['emailing_id'];  } ?>"  class="w_300"/><br /><br />
                 ...
                 <div id="div1" class="cus-padding-top">
                    ...
                    <p>
                      <br/>
                        ...
                        <button class="m_left_150" onclick="save_other_referral()">Save</button>
...
$(document).ready(function () { //alert(1); 
  ...
  $('.othersettingsection').next().slideDown();

  $('#zone_data_other_accordian').addClass('active');
  $("#addkeys").addClass('active');

   $('.othersettingsection').slideDown('slow');  
