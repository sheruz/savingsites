    ...
    <div class="container pt-4">
      <center><h1>Grocery Specials!</h1></center>
        ...
        <div class="row <?= $hide ?>" bis_skin_checked="1">
          ...
          <p class="<?= $hide ?>">Please login, so we can show you the grocery stores closest to your address. If you haven't signed-up, please do so here:</p>
        ...
        foreach ($result as $k1 => $v1) { 
          ...
          echo '<div class="col-lg-4 col-md-6 col-sm-12 entered shopoffer" ids="'.$v1->id.'">
            <p>
              ...
              <b><i class="fa-solid fa-house-chimney"></i>   Address:</b> '.$v1->address.','.$v1->city.','.$v1->zip.'<br>
              <b><i class="fa-solid fa-phone"></i>   Phone:</b> '.$v1->phone.'<br>
              <b><i class="fa-solid fa-car-side"></i>   Distance:</b> '.$v1->mileslat.' miles<br>
