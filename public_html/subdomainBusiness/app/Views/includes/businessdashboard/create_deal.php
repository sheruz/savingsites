              ...
              <div class="col-sm-6 left_col">
                <div class="peekaboo_cat" <?php if(@$_GET['mode'] != 'edit'){ echo 'style="display: none;"' ; } ?>>
                  ...
                  <div class="form_col radio-label  " <?php if(@$_GET['mode'] == 'edit'){ echo 'style="display: none;"' ; } ?>>
                    ...
                    <label for="no" class="right-label"><input type="radio" checked class="businessstatus" name="live_status" value="no">No</label>            
                  </div><br/>
                </div>
                ...
                <div class="deal_wraper" style="display: none;">
                  ...
                  <div class="form_col">
                    ...
                    <input name="start_date" type="text" class="comment" id="start_date" value="<?= date('Y-m-d') ?>" autocomplete="off">
                  </div> 
                  ...
                  <div class="form_col">
                    ...
                    <input name="end_date" type="text" class="comment " id="end_date" value="<?= date('Y-m-d', strtotime("+30 days")) ?>" autocomplete="off">          
                  </div> 
