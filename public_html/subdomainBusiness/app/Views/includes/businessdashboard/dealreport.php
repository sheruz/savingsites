...
<div class="page-wrapper main-area toggled viewdeals">
   <div class="container">
    ...
    <div class="row" style=" margin-bottom: 80px;">
         <div class="top-title">
            <h2>Deals Purchased Report</h2>
            <hr class="center-diamond">
            <p>This report lists all the deals sold by the business.</p>
          ...
          <div class="col-md-12">
            ...
            <div class="form-control row">
             ...
             <div class="col-md-4">
                ...
                <p>Deal Amounnt : <span id="dealamount"></span></p>  
          ...
          <div class="col-md-12">
            ...
            <div class="form-control row">
              <div class="col-md-12">
                ...
                <!-- <p>User Type : <span id="user_type">free</span></p>  -->
              </div>
            </div>
          </div>
        </div>
