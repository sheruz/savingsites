              ...
              <?php foreach ($dealArr as $k => $v) {
                echo '<tr>
                  ...
                  if($v['insert_via_csv'] == 1){
                    if(!empty($v['card_img'])){
                      echo '<td><img style="width:150px;height:100px;" src="https://cdn.savingssites.com/' . $v['card_img'] . '"/></td>';
                    }else{
                      echo '<td></td>';
                    }
                  }else{
            ...
            <div class="form-control row divided">
              ...
              <div class="col-sm-6 right_col" <?php if(@$_GET['mode'] != 'edit'){ echo 'style="display: none;"' ; } ?>>
                ...
                <div class="form_col">
                  ...
                  <input name="publisher_fee" type="number"  class="comment publisher_fee_show" id="publisher_fee"  value="<?php  //if(@$editdataresponse == 1){ echo $editdata[0]['publisher_fee'];   } ?>"  size="10" disabled/>
                   <input name="publisher_fee" type="hidden"  class="comment publisher_fee" id="publisher_fee"  value="<?php  //if(@$editdataresponse == 1){ echo $editdata[0]['publisher_fee'];   } ?>"  size="10"/>
                </div> 
