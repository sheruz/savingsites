...
<div id="help_shot" class="container_tab_header header-default-message bv_help_shot" margin-top:10px;>
    ...
    <div class="form-group">
      <div id="businessDataEdit">
        ...
        <?php if(!empty($my_businesses) && count($my_businesses) > 1){?>
  ...
  <div class="col-lg-6">
    ...
    <p class="form-group-row">
      ...
      <select class="" name="postalcode" id="postalcode">
        ...
        <option selected  value="<?= $adszip_code; ?>"><?= $adszip_code; ?></option>
      </select>
    </p>

    <p class="form-group-row">
      <label for="biz_about" class="fleft w_200">History<br /> </label>
      <textarea id="biz_history" name="biz_history" class="w_53601" ><?= isset( $business->history)?$business->history:'';?></textarea>
    </p>


    <p class="form-group-row">
      <label for="address" class="fleft w_200">State</label>
      <?= form_dropdown("biz_state", $state_list, 
      (!empty($get_bus_state_phone[0]['state']) ? $get_bus_state_phone[0]['state'] : ''), 'id="biz_state"');?>
      ...
      <input type="hidden" id="monday_active" class="active_days" value=""/>
               ...
               <form id="user-form" class="form-validate cus-form-bussness-tab2" enctype="multipart/form-data" name="adminForm" method="post" action="">
                ...
                <input type="hidden" id="userid" name="userid" value="<?= $userid; ?>"/>
                    ...
                    <p class="form-group-row">
                      <label for="gender" class="fleft w_100">Gender<span style="color: red;">*</span></label>
                      <?php 
                        $gender = isset($business_owner_details['gender'])?$business_owner_details['gender']:'';

                      ?>  
                      <select name="gender" id="busgender" class="form-select">
        ...
        <h2> Change Password</h2>
         <hr class="center-diamond">
          ...
          <div id="help_shot" class="container_tab_header header-default-message bv_help_shot" margin-top:10px;>
                 ...
                 <p>Use this form to change your password and then click “Update”.</p>
          ...
          <div style="width: 100%;" id="showdiv">
            ...
            <img id="output" style="width: 100%;" class="hide">
              <?php if($logo != ''){  ?>
                ...
                <div id="show_banner" style="background:url('<?= $logoimg ?>'); width: 32%;height: 45%;overflow: hidden;background-size: cover;background-repeat: no-repeat;background-position: center;">         
                </div>
              <?php } ?>
          </div>
            </div>
