            	...
            	<div id="tabs-1">
					...
					<div id="container">
				    	<div id="boxA" class="box">
				        	...
				        	<div id="A6" data-position='6' class="slot1 slot">
				            	<?php if(@$EmailformatingSaved){
				                  	$first = searchposition(@$EmailformatingSaved, '6', 'position'); 
				               		if(@$first){
				               			if(@$first->value !='business'){  ?>
				                  			<div id="b2"  data-id='<?php echo $first->value ?>'  class="item activeProp"><?php echo $first->value ?> List</div> 
				                  		<?php  } else if(@$first->value =='business'){  ?>
				        	...
				        	<div id="A7" data-position='7' class="slot1 slot">
				            	<?php if(@$EmailformatingSaved){
				                  	$first = searchposition(@$EmailformatingSaved, '7', 'position'); 
				               		if(@$first){
				               			if(@$first->value !='business'){  ?>
				                  			<div id="b2"  data-id='<?php echo $first->value ?>'  class="item activeProp"><?php echo $first->value ?> List</div> 
				                  		<?php  } else if(@$first->value =='business'){  ?>
				        	...
				        	<div id="A8" data-position='8' class="slot1 slot">
				            	<?php if(@$EmailformatingSaved){
				                  	$first = searchposition(@$EmailformatingSaved, '8', 'position'); 
				               		if(@$first){
				               			if(@$first->value !='business'){  ?>
				                  			<div id="b2"  data-id='<?php echo $first->value ?>'  class="item activeProp"><?php echo $first->value ?> List</div> 
				                  		<?php  } else if(@$first->value =='business'){  ?>
				        	...
				        	<div id="A9" data-position='9' class="slot1 slot">
				            	<?php if(@$EmailformatingSaved){
				                  	$first = searchposition(@$EmailformatingSaved, '9', 'position'); 
				               		if(@$first){
				               			if(@$first->value !='business'){  ?>
				                  			<div id="b2"  data-id='<?php echo $first->value ?>'  class="item activeProp"><?php echo $first->value ?> List</div> 
				                  		<?php  } else if(@$first->value =='business'){  ?>
				          	...
				          	<div id="A10" data-position='10' class="slot1 slot ">       
				               <?php $first = searchposition(@$EmailformatingSaved, '10', 'position');   
					...
					<div id="boxB" class="box">
	                	...
	                	<div id="B2" class="slot2 slot">
	              		...
	              		<div id="B4" class="slot2 slot">
	              			<?php $Sponser1 = search(@$EmailformatingSaved, 'Sponser1', 'value');  
	                     		if(!@$Sponser1){    ?> 
	                				<div id="b2" data-id='Sponser1'  class="item activeProp">sponser 1</div><?php } ?>  
	              		</div>
	              		<div id="B5" class="slot2 slot">
	              			<?php $Sponser2 = search(@$EmailformatingSaved, 'Sponser2', 'value');  
	                     		if(!@$Sponser2){    ?> 
	                				<div id="b2" data-id='Sponser2'  class="item activeProp">sponser 2</div><?php } ?>  
	              		</div>
	              		<div id="B6" class="slot2 slot">
	              			<?php $Sponser3 = search(@$EmailformatingSaved, 'Sponser3', 'value');  
	                     		if(!@$Sponser3){    ?> 
	                				<div id="b2" data-id='Sponser3'  class="item activeProp">sponser 3</div><?php } ?>   
	              		</div>
	              		<div id="B7" class="slot2 slot">
	              			<?php $Sponser4 = search(@$EmailformatingSaved, 'Sponser4', 'value');  
	                     		if(!@$Sponser4){    ?> 
	                				<div id="b2" data-id='Sponser4'  class="item activeProp">sponser 4</div><?php } ?> 
	                		 
	              		</div>
	              		<div id="B8" class="slot2 slot">
	              			<?php $Sponser5 = search(@$EmailformatingSaved, 'Sponser5', 'value');  
	                     		if(!@$Sponser5){    ?> 
	                				<div id="b2" data-id='Sponser5'  class="item activeProp">sponser 5</div><?php } ?>
	                		
	              		</div>
	           			<div id="B9" class="slot2 slot"> 
