                        ...
                        <div class="form-card">
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="password" class="validate[required,confirm[password]]" name="cpassword" autocomplete="new-password" id="cpassword" value=""/>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-6">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <input  type="text" id="org_username" name="org_username" autocomplete="new-password" onblur="username_verification();"/>
                              </div>
                              <div class="col-md-6">
