        ...
        <div class="col-md-4">
          <div class="row">
            <div class="col-md-12" style="padding:0;">
              <select class="form-control" id="businesslist">
                <option value="">Select Business</option>
                <?php foreach ($businessArr as $bk => $bv) {
                  echo '<option value="'.$bv->id.'">['.$bv->id.'] '.$bv->name.'</option>';
                }?>
              </select>
            </div>
          </div>
...
<div class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="deleteAudiomodal">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $(document).on('click','.weekday', function(){
       $('.weekday').prop('checked', false);
        ...
        var business_id = $('#businesslist').val();
        if(business_id == '' || business_id == undefined || business_id == 'undefined'){
          ...
          $.ajax({
            ...
            success: function(d){
              ...
              if(d.pdf != ''){
                ...
                $('#showpdf').html('<a target="_blank" href="'+pdfurl+''+d.pdf+'">Monday Special</a><i day="'+d.day+'" business_id="'+business_id+'" audio="" pdf="'+d.pdf+'" class="fa fa-trash deleterecord" aria-hidden="true"></i>');
              }else{
                $("#uploadpdfrow").removeClass('hide');
                $("#showpdfrow").addClass('hide');
                $('#showpdf').html('');
      ...
      $(document).on('change','#businesslist', function(){
      ...
      $(document).on('click','.filesaveformat', function(){
        ...
        $(this).prop('checked', true);
        var business = document.getElementById("businesslist").value;
        var day = '';
        var file = $(this).val();
        var file = '';
        if($(this).prop('checked') == true){
        ...
        if(business == '' || business == undefined || business == 'undefined'){
          savingalert('warning','Please Select Business');
          document.getElementById("businesslist").focus();
      ...
      $(document).on('click','#upload',function(){
        ...
        // if(audio_file_data == undefined && file_data == undefined){
    ...
    function filedata(){
      ...
      $('#businesslist').val('').trigger('change.select2');
      $('#audiouploaddiv').addClass('hide');
      $('#audiorecorddiv').addClass('hide');
    }
