...
<?php } ?>
	...
	<div class="container_tab_header">Announcements By High School Sports</div>
       ...
       <!-- <ul>
        ...
        <div id="tabs-1">  
        	...
        	<div class="form-group"> 
            	...
            	<div class="form-group new_announe" style="color:#222; font-size:13px;margin-top:10px; margin-bottom:0px; overflow:hidden;">
...
$(document).ready(function () { 
	...
	$('#zone_announcement_high_school').addClass('active');
...
function get_org_list(){
	...
	PageMethod("<?=base_url('Zonedashboard/get_highschool_org_list')?>/", "Displaying The Announcements...<br/>This may take a few minutes", data, getorglistsuccess, null);
