...
<?php } ?>
	...
	<div id="container_tab_content" class="container_tab_content">
        ...
        <div id="tabs-2">
            	...
            	<div class="container_tab_header header-default-message"> <p>Use Microsoft Office Picture Manager or Microsoft Paint to crop and resize your picture to the correct 2000 pixels wide and 471 pixels high to fit the banner<br/> For best results upload a 737 pixel wide x 1150 pixel high image </p></div>
                    ...
                    <tr>
                      <td  valign="top" bgcolor="#FFFFFF"><table width="100%" cellspacing="1" cellpadding="4" >
                          ...
                          <tr id="image" >
                            ...
                            <td  valign="middle" class="title_content_block bv_content_block"><div id="uplodImage">
                          ...
                          <tr>
                            <td  valign="middle" class="title_content_block bv_title_block">Status:</td>
...
$(document).ready(function () { 
  ...
  $('#add_banner_mobile').addClass('active');
...
function save_banner(){
	if($('#uploadedInput').val()!='' && $('#order').val()!=''){
		...
		PageMethod("<?=base_url('banner_controller/save_zone_bannermobile')?>", "Adding banner please wait ....", dataToUse, add_banner_insert, null);
    return false;
	}else{
		$('.form_error').show();
		var form_error='';
...
function ajaxFileUpload(){ //alert(1);
	...
	$('#spinner').show();
	 $.ajaxFileUpload(        		
	{
		url:'<?=base_url('banner_controller/save_banner_imagemobile/'.$zone_id.'')?>',
		secureuri:false,
