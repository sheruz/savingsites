...
function ajaxFileUpload2(){ //alert(1);
...

	{
		...
		url:'<?=base_url('banner_controller/edit_banner_image/'.$zone_id.'')?>',
		...
		{   //alert(data.uploadedImage);
            ...
            $('#bannerimage').attr('src',baseurl+'uploads/zone_banner/'+<?=$zone_id?>+'/'+data.uploadedImage);
...
<input type="hidden" name="viewable_tabid" id="viewable_tabid_<?=$banner_id?>" value=""/>
          ...
          <tr id="image" >
            ...
            <?php }?><?php */?>
              ...
              <?php if ($banner_view[0]['uploaded_by']!=0) { ?>
                ...
                <span style="display:none;   position: absolute;  right: 240px;margin-top: -24px;" id="spinner1"><img src="https://cdn.savingssites.com/loading.gif"></span>
              ...
              <div style="clear:both"></div>
				...
				<img style="width: 300px;" id="bannerimage" src="../../uploads/zone_banner/<?php echo $uploaded_by; ?>/<?php echo $banner_view[0]['image_name'];?>" />
