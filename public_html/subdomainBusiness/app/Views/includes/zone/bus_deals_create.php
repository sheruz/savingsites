...
<div class="main_content_outer">
 ...
 <h2 class="text-center">All Deals</h2><br/>
    ...
    <tbody>
      ...
      <?php      foreach ($auctiondata as  $value) {       ?>
        <tr>
            ...
            <td>
                <a href="<?php echo base_url() ?>/businessdashboard/createdeal/<?php echo $value['businessid']; ?>/<?php echo $zoneid; ?>">Add Deal</a>   
            </td>
        </tr> 
      <?php      } ?>
