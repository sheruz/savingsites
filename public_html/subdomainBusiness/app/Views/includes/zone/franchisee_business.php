    ...
    <div id="container_tab_content" class="container_tab_content">
      ...
      <div id="tabs-1">
        ...
        <div class="container_tab_header" style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px;">
        	...
        	<a href="javascript:void(0);" onclick="$('#fbt').slideToggle('slow')"><img src="https://cdn.savingssites.com/find.png" style="margin:7px 0 0 240px" width:"20px" height="20px" alt="Search Businesses" title="Search Businesses"/></a>
      ...
      <div id="tabs-2">
        <div class="form-group">
          <div class="container_tab_header" style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px;">
                ...
                <a href="javascript:void(0);" onclick="$('#fbp').slideToggle('slow')"><img src="https://cdn.savingssites.com/find.png" style="margin:7px 0 0 240px" width:"20px" height="20px" alt="Search Businesses" title="Search Businesses"/></a>
