...
<ul id="tab_view" style="display: none;">
	...
	<li id="tab_2_li"><a  onclick="tabshow('tab2');" style="cursor:pointer;text-decoration:none">Ordered Sponsor Business</a></li>
  ...
  <div class="businessname-heading">
      ...
      <?php } ?>  
         ...
         <?php /*?>   <?php if($common['sub_header_name_from_zone']['id']!=''){ ?>
            ...
            //echo '<pre>';var_dump($common['zone'][0]['type']);exit;?> <?php /*if($common['zone'][0]['type'] == 2){ ?>High School Sports :<?php }else{ */
    ...
    <div id="container_tab_content" class="container_tab_content">
      ...
      <div id="tabs-1">
        ...
        <div class="form-group">
            ...
            <button class="btn-sm businesscheck"  id="search_business" type="button">Search</button>
          ...
          <div class="view_non_temp_business bv_draggable_list" id="view_sponsored_business" style="display:none;"></div>
...
$(document).ready(function () { //alert(1); 
  ...
  $("#sponsor_business_cat").click();

  $('#sponsor_business_cat').next().slideDown();

//  $('#order_category_business').addClass('active');
...
$(document).on('click','.more_non_temp_business',function(){ //alert(5);
	...
	PageMethod("<?=base_url('Zonedashboard/get_ordered_sponsored_business_data_category_sort')?>", "Displaying Businessess...<br/>This may take a few minutes", data, successdata, null);
...
$(document).on('click','#back_to_business',function(){
	...
	function successdata(result){//alert(JSON.stringify(result));//return false;
