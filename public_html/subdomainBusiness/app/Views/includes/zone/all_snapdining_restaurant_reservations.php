...
<input type="hidden" id="userid" name="userid" value="<?php echo $common['user']->id; ?>"/>
...
<?php } ?>
  ...
  <div class="container_tab_header" style="position:relative;">
      ...
      <div style="padding:12px 0;"><span>Filtered Query Results</span><input type="hidden" id="exportpattern" value="" /></div>
 

    <div style="position:absolute; right:8px; top:8px;">

      <span><a href="javascript:void(0);" onclick="csvbusinessdownload($('#exportpattern').val());"><button style="background-color:#D01B13;color:white; margin-top:7px;"><b>Download Data</b></button></a></span>
      ...
      <div id="tabs-1">
        ...
        <div class="form-group">
          ...
          <div class="container_tab_header" style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px;display:none;">
                ...
                <a class="fright new-help-button" href="javascript:void(0);" onclick="$('#helpdiv1').slideToggle('slow')">HELP </a>
        ...
        <p>Search your business directly by entering the name inside "Direct search by business name" text box and click on the "Search" option. Or search businesses alphabetically by selecting the desired alphabet and then click on the "Search" option.</p>
          ...
          <!-- Search Part Start -->
            ...
            <div class="container_filter" id="trial_biz">
...
///////////////////////////////////////////////  N  E  W        S  E  C  T  I  O  N  /////////////////////////////////////////////////////
  ...
  $(document).on('click','.businesscheck',function(){ 
    ...
    console.log($('input[name="userid"]').val() , "sdfsdf");
   ...
   PageMethod("<?=base_url('Zonedashboard/all_snapdingreservations')?>", "Displaying Businessess...<br/>This may take a few minutes", data, successdata, null);
