        ...
        <div class="form-group">
          <div class="container_tab_header header-default-message"  style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px;">
            <div class="btn-group-2" align="left"> 
              ...
              <a href="javascript:void(0);" onclick="$('#csv_search_biz').slideToggle('slow')"><img src="https://cdn.savingssites.com/find.png" style="margin:7px 0 0 240px" width:"20px" height="20px" alt="Search Businesses" title="Search Businesses"/></a> 
        ...
        <div class="form-group">
          <div class="container_tab_header" style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px;">
            <div class="btn-group-2">
              ...
              <a href="javascript:void(0);" onclick="$('#man_search_biz').slideToggle('slow')"><img src="https://cdn.savingssites.com/find.png" style="margin:7px 0 0 240px" width:"20px" height="20px" alt="Search Businesses" title="Search Businesses"/></a> 
        ...
        <div class="form-group">
          <div class="container_tab_header header-default-message"  style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px;">
            <div class="btn-group-2" align="left">
              ...
              <a href="javascript:void(0);" onclick="$('#temp_trial_div').slideToggle('slow')"><img src="https://cdn.savingssites.com/find.png" style="margin:7px 0 0 240px" width:"20px" height="20px" alt="Search Businesses" title="Search Businesses"/></a> 
        ...
        <div class="form-group">
          <div class="container_tab_header header-default-message"  style="background-color:#d2e08f; color:#222; font-size:13px;margin-top:10px; margin-bottom:0px;">
            <div class="btn-group-2" align="left">
              ...
              <a href="javascript:void(0);" onclick="$('#temp_paid_div').slideToggle('slow')"><img src="https://cdn.savingssites.com/find.png" style="margin:7px 0 0 240px" width:"20px" height="20px" alt="Search Businesses" title="Search Businesses"/></a> 
