...
<div class="main_content_outer">
  <div class="content_container">
    <div class="container_tab_header">View Advertisements For Business Opportunity Providers</div>
...
$(document).ready(function () { 
	...
	$('#zone_franchisee_advertisement').addClass('active');
	$('#tab1').click();
...
function tabClick(val){ //alert(val); alert($('#zoneid').val());
	...
	var data={'zoneid':$('#zoneid').val(), 'approval':val, 'bustype':2}
...
function get_bus_list(){ //alert('anish');
	...
	var data = {'zoneid' : zoneid, 'userid' : userid, 'busvalue' : 2, 'char' : char, 'select_id' : select_id}
