...
$(document).ready(function () { 
	...
	$('#zonewebinar_services').addClass('active');
...
<?php } ?> 
	...
	<div class="container_tab_header">Webinar Services</div> 

    <div id="" class="container_tab_content ui-widget-content">              

        <h5 class="form-group-row"> Here are few webinar sites that you may like. </h5>            

        <div style="">

        <ul class="link-list vc_link_listing">

            <li><i class="zmdi zmdi-link zmdi-hc-lg"></i> https://talky.io/ - <a href="https://talky.io/" target="_blank">Click Here</a></li>

            <li><i class="zmdi zmdi-link zmdi-hc-lg"></i> https://www.anymeeting.com/ - <a href="https://www.anymeeting.com/" target="_blank">Click Here</a></li>

            <li><i class="zmdi zmdi-link zmdi-hc-lg"></i> http://www.clickwebinar.com/ - <a href="http://www.clickwebinar.com/" target="_blank">Click Here</a></li>

            <li><i class="zmdi zmdi-link zmdi-hc-lg"></i> https://www.bigmarker.com/host-a-webinar - <a href="https://www.bigmarker.com/host-a-webinar" target="_blank">Click Here</a></li>

            <li><i class="zmdi zmdi-link zmdi-hc-lg"></i> http://www.gotomeeting.com/webinar/join-webinar - <a href="http://www.gotomeeting.com/webinar/join-webinar" target="_blank">Click Here</a></li>
