...
<?php } ?>
	...
	<div class="container_tab_header">Enter the Credit Price</div>
	...
	<div id="container_tab_content" class="container_tab_content bv_create_bussines">
        ...
        <div id="tabs-1_x" class="form-group">
        	...
        	<div class="form-group ">
                ...
                <div class="page-subheading">Credit Price : $<?php echo $payment_creditprice ?> </div>

                <form id="credittobusiness" class="form-validate" name="" method="post" action="">
 
                 <p>
                   <label>Enter the price per credit.</label>
...
$(document).ready(function () {
  ...
  $('.submitprice').click(function(e){
     ...
     $formData =  $("#credittobusiness").serialize();
      ...
      $.ajax({
          url: '<?=base_url('/auth/updatecreditprice')?>',
          type: 'POST',
          dataType:'json', 
          data: ({ zoneID:'<?php echo $zone_id; ?>' , 'form': $formData }),
