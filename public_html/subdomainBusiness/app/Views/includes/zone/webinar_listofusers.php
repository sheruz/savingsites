...
$(document).ready(function () { 
	...
	$('#zonewebinar_infoinformationusers').addClass('active');
...
function Editwebinar(id){
	...
	window.location.href = "<?=base_url('Zonedashboard/edit_webinar/') ?>" + "/" + zoneid +"/"+ id ;
...
function showallwebinar(tag){ 
	...
	if(authenticate=='0'){
	 ...
	 if(limit=='' || limit==undefined){ 
		...
		PageMethod("<?=base_url('Zonedashboard/viewmorewebinar')?>/"+zoneid+"/"+lowerlimit+"/"+upperlimit+"/"+usersid, "Displaying the webinar info...<br/>This may take a few minutes", null, showAccounceInformation, null);
...
function showAccounceInformation(result){ 
	...
	if(result.Tag!=''){
		...
		if(adsno == 0){
			...
			$("#showannouncement").html('<div class="container_tab_header" style="background-color:#222; color:#CCC; font-size:13px; text-align:center; margin-top:10px; margin-bottom:0px;">No Webinar info Found.</div>');
...
function delete_webinar(id) { 
	 ...
	 ConfirmDialog("Really delete this information? ", "Delete Webinar", "<?=base_url('Zonedashboard/delete_webinar')?>", "Deleting webinar<br/>This may take a minute",{"id": id ,"zoneid": zoneid}, announceSaveSuccessful, null);
...
<div class="container_tab_header">View Webinar Information</div>
	...
	<div id="msg"></div>		<!--Message div Show after update-->
                ...
                <div id="helpdiv" class="container_tab_header header-default-message" margin-top:10px;>

                    <p></p>

                    <p>All Wedinar Informations.</p>
...
<tbody id=" " border="0" cellpadding="0" cellspacing="0">    

<?php  

foreach ($webinar_lists as   $value) {
 ...
 <tr >
        ...
        <td width="15%"><?php echo $value['username']; ?></td>
        
        <td width="40%" style="text-align:left;" class="responsive-image"><?php echo $value['email']; ?></td>
    ...
    <?php  }
       ...
       <div id="more_announcements" style="float:right;"><a id="my_announcements_limit" class="text-default" href="javascript:void(0)" onclick="showallwebinar(this);" rel="">Display more</a> </div>

       <?php }else{?>

       		<p><div id="not_found" class="container_tab_header" style="background-color:#222; color:#CCC; font-size:13px; text-align:center; margin-top:10px; margin-bottom:0px;">No webinar info found.</div></p>
