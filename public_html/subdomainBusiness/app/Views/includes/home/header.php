...
<html class="wide wow-animation" lang="en">
    ...
    <?php }   else if($zoneid>0 || $zoneid!=''){ ?>
        ...
        <meta property="og:image" content="<?= base_url(); ?>/assets/SavingsUpload/images/deals-img.jpg"/>    
        <meta property="og:url" content="" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="" />
        <meta name="twitter:creator" content="" />
        ...
        <meta name="twitter:image" content="<?= base_url(); ?>/assets/SavingsUpload/images/deals-img.jpg">
        <meta name="twitter:image:width" content="200px">
        <meta name="twitter:image:height" content="200px">  
        ...
        <meta property="linkedin:image" content="<?= base_url(); ?>/assets/SavingsUpload/images/deals-img.jpg"/>
    <?php }else{ ?>
    ...
    <?php } 
    // echo base_url("/manifest/".$zoneid."/".$business_theme."/manifest.json");die;
    if($zoneid == 672 || $zoneid == 598){
        $business_theme = isset($business_theme)?$business_theme:'blue';
        echo '<link rel="manifest" href="'.base_url("/manifest/".$zoneid."/".$business_theme."/manifest.json").'">';
        // <link rel="apple-touch-icon" href="images/logo192.png">
    }

    ?>
    <link rel="stylesheet" href="<?= base_url("/assets/css/bootstrap.css"); ?>" />
    <link rel="stylesheet" href="<?= base_url("/assets/css/home.css"); ?>?v=<?= microtime(true); ?>" />
    ...
    <link id="selTheme" href="<?= base_url();?>/assets/css/theme-<?= $theme ?>.css?v=<?= microtime(true); ?>" rel="stylesheet"/> 
    ...
    <link rel="stylesheet"  href="<?= base_url();?>/assets/SavingsCss/animate.css" type="text/css" media="all" />
    ...
    <body>
        ...
        <input type="hidden" name="zone_id" id="zone_id" value="<?=$zoneid?>"/>
