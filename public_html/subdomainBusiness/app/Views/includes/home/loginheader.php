...
<header class="section page-header after_login_header">
                ...
                <!-- <li class="rd-nav-item save_hide_banner">Close Banner</li> -->
                     ...
                     <li class="rd-nav-item themeswitcher">
                        <div class="dropdowns" style="">
                           <button class="btn btn-default dropdown-toggle btn-link icon-theme" type="button" id="themeswitcher1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style=""><?= $page; ?></button>
                     ...
                     <?php if($session_session_normal_user_type=='resident_user'){ ?>
                                ...
                                <?php  if (isset($req_url) && $req_url != '' ) { ?>
                                     <a href="<?= $req_url ?>" class="">
                                        <i class="fa fa-edit text-primary "></i> 
                                            Back To Dashboard
                                    </a>
                                <?php }else{ ?>
                                    <a href="<?=base_url() ?>/Zonedashboard/zoneinformation/<?= $zoneid; ?>" class=""><i class="fa fa-edit text-primary "></i> Back To Dashboard</a>
                                <?php } ?>
                     ...
                     <div class="logo">
                        <ul class="logo-row first-row">
                              ...
                              <img src="https://cdn.savingssites.com/new-savingssites.png"/>
