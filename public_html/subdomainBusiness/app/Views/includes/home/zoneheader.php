<header class="section page-header">
   <div class="header-top">
      <div class="container">
         <div class="row justify-content-center align-items-xl-center middleofrow">
            <div class="col-sm-12">
            ...
            <div class="col-12 col-lg-3 col-md-12 fixed-3">
            ...
            <div class="col-12 col-lg-6 col-md-4 bv_welcome_col fixed-3">
               <ul class="list-inline user-menu topheaderimages ">
                  <li class="topheadersection user-register deals">
                     <a class=" " href="https://<?= $zonebusinessname ?>.savingssites.com" target="_blank"><img class="logo-ssb" style="" src="https://cdn.savingssites.com/new-savingssites3.png"></a>
                  </li>
                  <!-- <li class="topheadersection user-register deals"><button type="button" class="btn btn-info addtohomescreen1 bv_header_breadcrumb">+1</button></li>
                  <li class="topheadersection user-register deals"><button type="button" class="btn btn-info addtohomescreen bv_header_breadcrumb">+2</button></li> -->
               </ul>
            </div>
            <div class="col-12 col-lg-3 col-md-12 head_last_col fixed-3">
                  ...
                  <li class="user-login">
                     <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton13">
                           ...
                           <a title="employee_login" class="loginTextChange1 dropdown-item toggle-btn-pop" data-toggle="modal" data-target="#login-box2" title="employee_login" href="javascript:void(0);">Local Employee</a>
                           ...
                           <a title="sponsor_login" class="loginTextChange1 dropdown-item toggle-btn-pop" href="javascript:void(0);" data-toggle="modal" data-target="#login-box2" id="sponsor_login" title="sponsor_login">Sponsor</a>
                        </div>
                     </div>
                  </li>
                        ...
                        <ul class="dropdown-menu_list1" id="menu-bar" style="display: none;">
                           <div class="cus_menu">
                              <li class="user-register fullwidth">
                                 <a  href="<?=base_url() ?>" class=" cus-top-pad"><i class="fa fa-home"></i> $$ Home</a>
                              </li>
                           ...
                           <div class="logoss">
                              <ul class="logo-row first-row">
                                 <li>
                                    <a href="https://<?= @$zonebusinessname ?>.savingssites.com" target="_blank"><img class="disable 3" style="" src="https://cdn.savingssites.com/new-savingssites.png"></a>
                                 </li>
                              </ul>
                           </div>
                        </ul>
