...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <?php clearstatcache(); 
    if($adid!=''){
        $description = 'Save money without cutting, collecting, organizing, coupons, or being bombarded with emails for offers you don\'t want and are out of your area.';
     ?>
        ...
        <?php if($addlist){  
            ...
            if($addlist[0]['buy_price_decrease_by'] == ''){$addlist[0]['buy_price_decrease_by'] = 0;}
            if($addlist[0]['current_price'] == ''){$addlist[0]['current_price'] = 0;}
            if($addlist[0]['publisher_fee'] == ''){$addlist[0]['publisher_fee'] = 0;}
            ...
            if(empty($description)){$description=$bnamenew;}  
