...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	...
	public $defaultGroup             = 'Tier III';//'members';           // Default group, use name
	public $adminGroup               = 'Tier I';//'admin';             // Default administrators group, use name
	public $identity                 = 'username';/*'email';*/             /* You can use any unique column in your table as identity column.
	...
	public $userExpire               = 0;//86500;               // How long to remember the user (seconds). Set to zero for no expiration
